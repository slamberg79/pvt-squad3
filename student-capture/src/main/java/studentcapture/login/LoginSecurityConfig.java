    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers("/index").access("hasRole('USER') or hasRole('ADMIN')") //Users and admins can access /loggedin
                .antMatchers("/admin").access("hasRole('ADMIN')") //Admins can access /admin
                .antMatchers("/login").permitAll()
                .antMatchers("/user").permitAll()
                .antMatchers("/videoDownload/bugsbunny").permitAll()
            ...
            .formLogin()
              ...
              //.successHandler(customLoginHandler) //Custom redirection based on role
                .defaultSuccessUrl("/index", true) //always redirect to "/loggedin"
                .and()
            .logout()
                .logoutUrl("/logout")
                .permitAll()
